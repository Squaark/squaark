...
describe('getRatesForCountry', () => {
  ...
  describe('with zones configured', () => {
    ...
    it('falls back to the wildcard zone for an unmatched country', () => {
      ...
      expect(rates).toEqual([{ id: expect.any(String), name: 'Standard', amount: 995, isFree: false, isPickup: false, pickupAddress: null, pickupInstructions: null, schedule: null }]);
    });
