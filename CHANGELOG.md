...
### Added
- Nova theme: a second bundled storefront theme with a bold, modern DTC look (heavy type, vibrant accent, rounded lifted product cards, sticky header, dark footer) and a hero **product slider** (auto-advancing, arrows + dots, driven by the first featured section). As configurable as Linen via the theme customizer; activate it in Admin → Themes.
